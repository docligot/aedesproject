...
function loadCombo() {
  document.getElementById('dengueHeadDiv').innerHTML = '<canvas id="dengueForecastDiv"></canvas>';
  var series1 = document.getElementById('axis_1').value;
  var series2 = document.getElementById('axis_2').value;
  if (series1 && series2) {
...
function comboChart(label, data1, data2, dataset1, dataset2) {
  ...
  var ctx = document.getElementById('dengueForecastDiv').getContext('2d');
